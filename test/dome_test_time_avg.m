list_filenames = dir('data/dome_test');
...
savefig('test/figs/dome_dist_signal.fig');
saveas(gcf, 'test/figs/dome_dist_signal.jpg');
...
savefig('test/figs/dome_user_input_signal.fig');
saveas(gcf, 'test/figs/dome_user_input_signal.jpg');
...
savefig('test/figs/dome_sys_output_signal.fig');
saveas(gcf, 'test/figs/dome_sys_output_signal.jpg');
...
savefig('test/figs/dome_abs_pilot_tf.fig');
saveas(gcf, 'test/figs/dome_abs_pilot_tf.jpg');
...
savefig('test/figs/dome_phase_pilot_tf.fig');
saveas(gcf, 'test/figs/dome_phase_pilot_tf.jpg');
...
saveas(gcf, 'test/figs/dome_abs_pilot_coeff.jpg');
...
saveas(gcf, 'test/figs/dome_phase_pilot_coeff.jpg');
